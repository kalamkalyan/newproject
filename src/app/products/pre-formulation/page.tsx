...
import PreFormulationClient from "@/components/PreFormulationClient";
import Image from 'next/image';
import type { Metadata } from "next";

export const metadata: Metadata = {
  title: "Pre-Formulation Intermediates | Therallen Pharma",
  description:
    "Explore Therallen Pharma's advanced pre-formulation intermediates including pellets (IR, SR, ER, EC) and direct compressible (DC) granules, designed by design for pharmaceutical formulators.",
};
          ...
          <div className="mx-auto max-w-7xl h-full px-6 lg:px-8 flex items-center relative z-10">
            ...
            <div className="w-1/2 md:w-[50%] flex flex-col justify-center space-y-3">
              ...
              <div className="flex items-center gap-1.5 text-xs sm:text-sm font-medium">
                ...
                <span className="text-white/40">/</span>
                <span className="text-white/85">Pre-Formulation Intermediates</span>
              </div>
            </div>
          </div>
